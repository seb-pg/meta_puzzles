...
object Solution {
    ...
    def tests(): Int =
    {
        ...
        val args_list = Array[Args](
            Args(Array[String](".***", "**v>", ".*.."), 4),
            Args(Array[String](">**", "*>*", "**>"), 4),
            Args(Array[String](">>", "**"), 0),
            Args(Array[String](">*v*>*", "*v*v>*", ".*>..*", ".*..*v"), 6),
            // extra1
            Args(Array[String](), 0),
            Args(Array[String]("."), 0),
            Args(Array[String]("v"), 0),
            Args(Array[String](">"), 0),
            Args(Array[String]("*"), 1),
            // extra2
            Args(Array[String](".", ".", ">", "*"), 0),
            ...
            Args(Array[String](".", "*", ">", "."), 1),
            Args(Array[String]("*", ".", ">", "."), 1),
            Args(Array[String]("***", "...", ">vv", "..."), 1),
            // extra3
            Args(Array[String]("*....", ".*...", "..*..", "...*."), 4),
            Args(Array[String]("....", "....", "....", "...."), 0),
            Args(Array[String]("***>", "...."), 3),
            Args(Array[String]("*"), 1),
            Args(Array[String]("vvvv"), 0),
            Args(Array[String]("vvvv", "....", ">>>>"), 0),
            // extra4
            Args(Array[String]("******", "......", ">*>vvv", "......"), 2),
            Args(Array[String]("*****", ".....", ">>vvv", "....."), 1),
        )
