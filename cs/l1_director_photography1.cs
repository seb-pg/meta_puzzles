...
class Solution {
    ...
    public static int tests()
    {
        ...
        Func<Args, int> wrapper = (Args p) => s.getArtisticPhotographCount(p.C.Length, p.C, p.X, p.Y);
        ...
        return test_all.TestAll.run_all_tests("l1_director_photography1", args_list, wrapper);
    }
