...
fun getUniformIntegerCountInInterval(A: Long, B: Long): Int {
    ...
    val nb_b = B / tmp_b;
    val nb_m = if (len_b - len_a >= 2) (9 * (len_b - len_a - 1)) else { 0 };
...
fun tests(): UInt
{
    ...
    val args_list: List<Args> = listOf(
        Args( 75, 300, 5 ),
        Args( 1, 9, 9 ),
        Args( 999999999999, 999999999999, 1 ),
        // extra1
        Args( 1, 1_000_000_000_000, 108 ),
        // extra2
        Args( 10, 99, 9 ),
        Args( 11, 98, 8 ),
        Args( 21, 89, 7 ),
