...
auto tests()
{
    ...
    std::vector<NamedTests<Args, double>> tests = {
        ...
        {"extra1", {
                ...
                //
                { { { 10 }, { 0 }, { 1'000'000 } }, 1'000'000.0 },
                { { { 10 }, { 0 }, { 500'000 } }, 1'000'000.0 },
                { { { 9 }, { 500'000 }, { 1'000'000 } }, 1'000'000.0 },
                { { { 10, 9 }, { 0, 500'000 }, { 500'000, 1'000'000 } }, 1'000'000.0 },
                //
                { { { 20, 10 }, { 200'000, 400'000 }, { 600'000, 800'000 } }, 155'000.0 },
                { { { 20, 10 }, { 400'000, 200'000 }, { 800'000, 600'000 } }, 155'000.0 },
                { { { 20, 20, 10 }, { 100'000, 500'000, 200'000 }, { 300'000, 700'000, 600'000 } }, 155'000.0 },
                //
